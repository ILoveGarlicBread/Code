...
public class WebsitesUtils {
  ...
  public void downloadWebPageContent()
    ...
    HttpResponse<byte[]> response = httpClient.send(request,
        HttpResponse.BodyHandlers.ofByteArray());
    String savePath = "/home/lam/Code/Year3/SWE-D/websitemonitor/contentsnapshot/" +
        websiteName + ".html";
    if (response.statusCode() == 200) {
      byte[] responseBody = response.body();
      Path file = Path.of(savePath);
  ...
  public boolean compareWebPageContent(CompareMethod method) throws IOException,
    ...
    String readPath = "/home/lam/Code/Year3/SWE-D/websitemonitor/contentsnapshot/" + websiteName + ".html";
